...
def robot_navigation(kobuki, color="white", y_center=240, gap=40, x_center=320, forward_speed=150):
    """
    ...
    Returns:
        bool: True if navigation successful, False if error occurred
    """
    ...
    # This helps avoid while loops in movement_control
